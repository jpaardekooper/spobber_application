...
import 'package:logintest/Users.dart';
...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _loginAnimation = Tween(begin: 250.0, end: 50.0).animate(
      new CurvedAnimation(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            errorText:
                                invalidInfo ? 'Invalid user information' : null,
            ...
            Center(
              child: Padding(
                padding: EdgeInsets.only(
                  top: (MediaQuery.of(context).size.height - 30) * 0.4,
                ),
                child: Container(
                  width: 180,
                  height: 30,

...
class TensorFlow extends StatefulWidget {
  @override
  TensorFlowState createState() => new TensorFlowState();
}

class TensorFlowState extends State<TensorFlow> {
  File _image;
  List _recognitions;
      ...
      switch (_model) {
        case yolo:
          res = await Tflite.loadModel(
            model: "assets/tensorflow/yolov2_tiny.tflite",
            labels: "assets/tensorflow/yolov2_tiny.txt",
          );
          break;
        case ssd:
          res = await Tflite.loadModel(
              model: "assets/tensorflow/ssd_mobilenet.tflite",
              labels: "assets/tensorflow/ssd_mobilenet.txt");
          break;
        case deeplab:
          res = await Tflite.loadModel(
              model: "assets/tensorflow/deeplabv3_257_mv_gpu.tflite",
              labels: "assets/tensorflow/deeplabv3_257_mv_gpu.txt");
          break;
        case posenet:
          res = await Tflite.loadModel(
              model: "assets/tensorflow/posenet_mv1_075_float_from_checkpoints.tflite");
          break;
        default:
          res = await Tflite.loadModel(
            model: "assets/tensorflow/mobilenet_v1_1.0_224.tflite",
            labels: "assets/tensorflow/mobilenet_v1_1.0_224.txt",
          );
      }
      print(res);

...
class TutorialSpot extends StatefulWidget {
  @override
  State createState() => new TutorialSpotPageState();
}

class TutorialSpotPageState extends State<TutorialSpot> {
  final _controller = new PageController(viewportFraction: 0.8);
